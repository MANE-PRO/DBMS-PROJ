...
CREATE TABLE vendors (
    ...
    zip VARCHAR2(20),
    country VARCHAR2(100),
    FOREIGN KEY (plants_name) REFERENCES plants(scientific_name)
);

INSERT INTO plants (scientific_name, medicinal_rating, bioactivity, edibility)
